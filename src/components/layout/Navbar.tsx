      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 flex justify-between items-center max-w-7xl">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button
            ...
            className="flex items-center gap-1.5 py-2 px-3.5 rounded-full text-xs font-black bg-orange-500 hover:bg-orange-600 text-white transition-all shadow-md hover:scale-105"
          >
            <Download size={15} />
